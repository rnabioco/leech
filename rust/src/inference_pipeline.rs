...
// ---------------------------------------------------------------------------
// Per-read processed signal (shared between inference and training)
// ---------------------------------------------------------------------------
...
struct ProcessedRead {
    ...
    use_sequence: String,
    dwells: Vec<f32>,
    features_data: Option<Vec<Vec<f32>>>,
    num_features: usize,
    sig_residual: Option<Vec<f32>>,
}
...
// ---------------------------------------------------------------------------
// Inference per-read result (plain Rust, no PyO3 — safe for rayon)
// ---------------------------------------------------------------------------
...
impl BaseJustify {
    ...
    fn focus_pos(self, sig_start: i64, sig_end: i64) -> i64 {
        match self {
