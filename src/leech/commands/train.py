...
def handle_train(
    ...
    **model_kwargs: Any,
    ...
    _explicit_keys = {
        "loss_type", "scheduler", "scheduler_patience", "scheduler_factor",
        "warmup_epochs", "weight_decay", "max_grad_norm", "learning_rate",
        "epochs", "batch_size", "early_stopping_patience", "use_class_weights",
        "pos_weight", "mixed_precision", "focal_gamma", "augment_jitter",
        "augment_scale_min", "augment_scale_max", "num_workers",
        "seq_encoding", "balance_groups", "device", "seed",
        "motif", "motif_offset", "base_justify",
    }
